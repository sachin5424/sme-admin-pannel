...
@Component({
  ...
  styleUrls: ['./ads-add-edit.component.scss']
})
   ...
   addForm(){
       ...
       this.Form = new FormGroup({
          ...
          //  slug : new FormControl(update.title?update.title:'',[Validators.required, Validators.minLength(2)]),
           link : new FormControl(update.link?update.link:'',[Validators.required,]),
           type:new FormControl(update.type?update.type:'',[Validators.required,]),
           openIn:new FormControl(update.openIn?update.openIn:'',[Validators.required,]),
       })
   }
...
//   formDirective.resetForm()
       ...
       if(this.Form.valid){
        ...
        this._http.post(environment.ads_save,this.Form.value).subscribe((res:any)=>{
           console.log(res);
